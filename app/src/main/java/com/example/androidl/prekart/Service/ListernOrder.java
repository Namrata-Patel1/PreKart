package com.example.androidl.prekart.Service;
...
import com.example.androidl.prekart.OrderStatus;
...
public class ListernOrder extends Service implements ChildEventListener{
    FirebaseDatabase db;
